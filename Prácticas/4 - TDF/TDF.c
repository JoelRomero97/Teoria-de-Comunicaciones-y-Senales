...
//// La opción 1 de la TDF mostrará en el canal izquierdo la señal original y en el ////
//// derecho, la magnitud de la TDF.												////
//// En la opción 2, mostrará en el canal izquierdo la parte real de la TDF y en el ////
//// derecho, la parte imaginaria de la TDF.										////
//// En la opción 3, mostrará en el canal izquierdo la magnitud de la TDF y en el 	////
//// derecho, la fase de la TDF.													////
////																				////
////																				////
